...
async function setBooks(book) {
  await (0,firebase_firestore_lite__WEBPACK_IMPORTED_MODULE_1__.setDoc)((0,firebase_firestore_lite__WEBPACK_IMPORTED_MODULE_1__.doc)(db, "books", book.title), {
    title: book.title,
    author: book.author,
    pages: book.pages,
...
async function setHaveRead(book, haveRead) {
  await (0,firebase_firestore_lite__WEBPACK_IMPORTED_MODULE_1__.updateDoc)((0,firebase_firestore_lite__WEBPACK_IMPORTED_MODULE_1__.doc)(db, "books", book.title), {
    haveRead: haveRead,
  });
}

async function deleteBook(book) {
  await (0,firebase_firestore_lite__WEBPACK_IMPORTED_MODULE_1__.deleteDoc)((0,firebase_firestore_lite__WEBPACK_IMPORTED_MODULE_1__.doc)(db, "books", book.title));
}

async function getBooks(db) {
  const booksCol = (0,firebase_firestore_lite__WEBPACK_IMPORTED_MODULE_1__.collection)(db, "books");
  const bookSnapshot = await (0,firebase_firestore_lite__WEBPACK_IMPORTED_MODULE_1__.getDocs)(booksCol);
